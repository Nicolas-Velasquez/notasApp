...
function mostrarMensaje(promedio){
    let mensaje = promedio>=3?"Felicitaciones aprobó":"Lo sentimos vuelva a intentar"
...
function mostrarActividades(){
    ...
    for(let index in notas){
        ...
        filas += "  <td>"
        filas += "      <button onclick='modificarActividad("+index+")'>Modficar</button>"
